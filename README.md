...
Для рисования мы воспользуемся языком mermaid. В файле с расширением .md стоит написать три одинарные кавычки, пропустив до этого строку, после кавычек написать имя языка, т.е. _mermaid_. Даллее с помощью стрелок мы можем рисовать графы:  
